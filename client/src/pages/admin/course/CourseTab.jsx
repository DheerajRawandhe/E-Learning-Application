...
import { useEditCourseMutation,useGetCourseByIdQuery,usePublishCourseMutation,
...
const CourseTab = () => {
  ...
  const [input, setInput] = useState({
    courseTitle: "", subTitle: "", description: "", category: "", courseLevel: "", coursePrice: "",courseThumbnail: "",
  });
      ...
      <CardContent>
        <div className="space-y-4 mt-5">
          ...
          <div>
            ...
            <Input type="text" name="subTitle" value={input.subTitle} onChange={changeEventHandler}
          ...
          <div>
            ...
            {previewThumbnail && ( <img src={previewThumbnail} className="e-64 my-2" alt="Course Thumbnail" /> )}
          </div>
          <div>
