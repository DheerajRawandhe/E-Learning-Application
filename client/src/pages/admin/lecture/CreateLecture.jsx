...
const CreateLecture = () => {
  ...
  const createLectureHandler = async () => { await createLecture({ lectureTitle, courseId })};
  ...
  return (
    <div className="flex-1 mx-10">
      ...
      <div className="space-y-4">
        ...
        <div className="mt-10"> {lectureLoading ? (<p>Loading lectures...</p>
        ) : lectureError ? (<p>Failed to load lectures.</p> ) : lectureData.lectures.length === 0 ? (
            <p>No lectures availabe</p>) : ( lectureData.lectures.map((lecture, index) => (
