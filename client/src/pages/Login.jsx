          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <div className="space-y-1">
                ...
                <Input type="text" name="name" value={signupInput.name} onChange={(e) => changeInputHandler(e, "signup")} placeholder="Eg. Dheeraj" required="true" />
              </div>
              <div className="space-y-1">
                <Label htmlFor="username">Email</Label>
                <Input type="email" name="email" value={signupInput.email} onChange={(e) => changeInputHandler(e, "signup")} placeholder="Eg. dheeraj@gmail.com" required="true" />
              </div>
              <div className="space-y-1">
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <div className="space-y-1">
                ...
                <Input type="email" name="email" value={loginInput.email} onChange={(e) => changeInputHandler(e, "login")} placeholder="Eg. dheeraj@gmail.com" required="true" />
              </div>
              <div className="space-y-1">
